...
export const translations = {
  en: {
    ...
    aboutSummaryCopy: "I am a user-focused product designer with a foundation in computer science and over five years of experience transforming complex challenges into intuitive, user-centered digital products that improve clarity, trust, and decision-making.",
    ...
    languagesVal: "English, Korean, Japanese",
    currentlyVal: "Product Designer",
    yearsActiveVal: "5+ years of experience",
    ...
    processSub: "Finding the clearest path through the work.",
    solutionLabel: "05 / The Solution",
    solutionSub: "A system designed to make the important parts easier to see.",
    finalImagesLabel: "06 / Final Images",
    finalImagesSub: "Every screen from the finished design.",
    roleHeading: "Role",
  ...
  ja: {
    ...
    languagesLabel: "言語",
    currentlyLabel: "現在",
    yearsActiveLabel: "活動年数",
    locationVal: "米国ニューヨーク州ニューヨーク",
    languagesVal: "英語、韓国語、日本語",
    currentlyVal: "プロダクトデザイナー",
    yearsActiveVal: "5年以上の経験",
    ...
    processSub: "課題解決に向けた最も明確なアプローチの探求。",
    solutionLabel: "05 / ソリューション",
    solutionSub: "重要情報を直感的に提示するためのデザインシステム。",
    finalImagesLabel: "06 / 最終デザイン画像",
    finalImagesSub: "完成したデザインのすべての画面。",
    roleHeading: "役割",
    timelineHeading: "期間",
    toolsHeading: "ツール",
  ...
  ko: {
    ...
    languagesLabel: "언어",
    currentlyLabel: "현재",
    yearsActiveLabel: "활동 경력",
    locationVal: "미국 뉴욕주 뉴욕",
    languagesVal: "영어, 한국어, 일본어",
    currentlyVal: "프로덕트 디자이너",
    yearsActiveVal: "5년 이상의 경력",
    ...
    processSub: "작업 과정에서 가장 명확한 해결책을 찾아가는 여정.",
    solutionLabel: "05 / 솔루션",
    solutionSub: "핵심 요소를 더욱 쉽게 파악할 수 있도록 설계된 시스템.",
    finalImagesLabel: "06 / 최종 이미지",
    finalImagesSub: "완성된 디자인의 모든 화면.",
    roleHeading: "역할",
    timelineHeading: "기간",
    toolsHeading: "도구",
...
export const projectTranslations = {
  ja: {
    velocity: {
      ...
      research: "臨床情報、アクセスサポート、事前承認手順、資金援助プログラム、登録フォームを包括。複雑に絡み合うニーズを単一の体験で直感的に探せるように設計することが課題でした。",
      process: "信頼と明確さを基調としたデザインシステムを構築。デザイン、コンテンツ、開発の各領域でページフローやナビゲーションを洗練させ、臨床データから患者ツールへ滑らかに移動できるように設計しました。",
    ...
    'gaming-gear': {
      ...
      research: "プレイヤーがどのように機材をリサーチし、スペックを比較し、購入前に実使用感を確認するかを調査。おすすめ、レビュー、比較を一本のフローに統合する機会を発見しました。",
      process: "探索ジャーニーをマッピングし、個別推奨、並列比較、コミュニティの各フローをテスト・設計。必要な詳細情報を損なうことなく迅速な決定を優先させました。",
    ...
    'gl-hcp-ectrims-booth': {
      ...
      research: "ECTRIMSでのブース内動線や、数秒で視線を惹きつける要素、キオスク前で立ちながら吸収できる情報量を分析しました。",
      process: "長文の読解よりも迅速な把握を優先し、臨床コンテンツを視覚的モジュールに分解したタッチスクリーンフローを構築・調整しました。",
    ...
    'sibos-tote-bag': {
      ...
      research: "バッグのレイアウトや印刷フォーマット、ESG視覚要素を研究し、高コントラストな案から落ち着いたナチュラルカラーまで幅広く模索しました。",
      process: "アグレッシブすぎた初期案から方向転換し、オーガニックな色合いと親しみやすい書体を採用。自由の女神などのランドマークとQRコードを融合させました。",
  ...
  ko: {
    velocity: {
      ...
      research: "임상 정보, 환자 지원 리소스, 사전 승인 단계, 재정 지원 프로그램 및 등록 양식을 한데 모아 직관적으로 탐색할 수 있도록 설계했습니다.",
      process: "신뢰와 명확성을 바탕으로 한 디자인 시스템을 구축하여, 디자인, 콘텐츠, 개발에 걸쳐 임상 데이터에서 환자 지원 도구로 매끄럽게 이동할 수 있도록 흐름을 정제했습니다.",
    ...
    'gaming-gear': {
      ...
      research: "게이머들이 장비를 검색하고 사양을 비교하며 실사용 피드백을 찾는 방식을 분석하여 추천, 리뷰, 비교 기능을 하나의 흐름으로 결합했습니다.",
      process: "장비 탐색 여정을 매핑하고 개인화 추천, 나란히 비교, 커뮤니티 토론 흐름을 테스트 및 설계하여 빠르게 의사결정을 내릴 수 있도록 돕습니다.",
    ...
    'gl-hcp-ectrims-booth': {
      ...
      research: "ECTRIMS 학회 부스에서 의료진이 이동하는 동선과 짧은 시간 내 시선을 사로잡는 요소, 서서 수용할 수 있는 정보량을 조사했습니다.",
      process: "긴 글을 읽기보다 빠르게 파악할 수 있도록 임상 콘텐츠를 시각적 모듈로 분할하고 학회 환경에 적합한 페이싱을 설계했습니다.",
    ...
    'sibos-tote-bag': {
      ...
      research: "토트백 가방 레이아웃, 인쇄 포맷 및 ESG 시각 요소를 연구하고 하이 콘트라스트 색상부터 조화로운 친환경 컬러까지 탐색했습니다.",
      process: "과도하게 강렬했던 초기 시안에서 탈피하여 정돈된 어스 톤과 친근한 타이포그래피, 자유의 여신상 등의 랜드마크와 QR 코드를 결합했습니다.",
...
export function LanguageProvider({ children }) {
  ...
  const translateProject = (project) => {
    ...
    return {
      ...
      research: trans.research || project.research,
      process: trans.process || project.process,
